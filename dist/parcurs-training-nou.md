...
*Secțiunile [generat] provin din `build/verifica.py`, `date/ordine.py`, `date/documente.py` și din workbook-urile construite. 29 porți, 22 module, 80 fluxuri la data generării.*
