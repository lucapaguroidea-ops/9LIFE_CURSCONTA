...
*Secțiunile [generat] provin din `build/verifica.py`, `date/ordine.py`, `date/documente.py` și din workbook-urile construite. 26 porți, 19 module, 68 fluxuri la data generării.*
