...
from . import (aprov_tranzit, capitaluri, credit_valuta, decont, iesire_mf,
               imobilizari,
               inchidere_ex, tva_incasare, neutralizare, inchidere_lunara, inchidere_tva, intermediar,
               leasing_fin, neutralizare, tva_incasare,
...
MODULE = [capitaluri, credit_valuta, provizion, leasing_fin,
          ...
          inchidere_ex, tva_incasare, neutralizare,
